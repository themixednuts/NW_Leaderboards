...
<div
  class="my-grid-row no-scrollbar container relative mx-auto grid max-h-screen min-h-screen grid-cols-1 place-content-center gap-4 overflow-y-auto overflow-x-hidden"
>
  <div
    class="navbar z-50 col-span-full row-start-1 row-end-2 max-h-full justify-between bg-base-100"
  >
    <a href="/" class="btn-ghost btn text-xl capitalize">NW Stats</a>
    <div class="flex">
      <a
        href="https://discord.gg/UQ3Q4SBqND"
        target="_blank"
        rel="noopener noreferrer"
        class="btn-ghost btn relative"
      >
        <svg
